...
<div class="w3-main" style="margin-left:250px;">
  ...
  <div class="w3-container w3-padding-32" style="padding-left:32px">
    ...
    <div class="w3-center" style="padding-bottom:32px">
      <button class="w3-btn w3-red" onclick="javascript:location.href='search_lifelog.php'">餵養紀錄</button>
    ...
    <div class="w3-content" >
      <div class="mySlides  w3-animate-left" style="width:100%">
          ...
          <form action="search_lifelog.php" method="post">
		  餵養時間
        ...
        <div class="w3-container w3-sand w3-padding-32">
		  ...
		  <form action="update_lifelog.php?id=1" method="post">
		    <input class="w3-input w3-border w3-round-large w3-green" type="submit" value="修改"/>
            <table class="w3-table" id="store">
              <tr>
                <th  class="w3-blue w3-center">豬隻編號</th>
                <th  class="w3-blue w3-center">餵養種類</th>
                <th  class="w3-blue w3-center">餵養量</th>
                <th  class="w3-blue w3-center" style="width:30%">餵養時間</th>
                <th  class="w3-blue w3-center" >餵水量</th>
              </tr>
              <?php
              if($key==null && $key1==null){
                  $sql_basic = "SELECT * FROM `feed_record`";
              }
              if($key!=null)
              {
                  $sql_basic = "SELECT * FROM `feed_record` where Feed_Time LIKE '".$key."%'";
              }
              if($key1!=null)
              {
                  $sql_basic = "SELECT * FROM `feed_record` where Pig_ID='".$key1."'";
              ...
              while($row_basic = mysql_fetch_array($result_basic)){
				...
				<input type="hidden" name="t0[]" value="<?php echo $row_basic['ID']; ?>">
                  <td><input class="w3-input w3-border w3-round-large " type="text" name="t1[]" value="<?php echo $row_basic['Pig_ID']; ?>" disabled ></td>
                  <td><input  class="w3-input w3-border w3-round-large"  type="text" name="t2[]" value="<?php echo $row_basic['Feed_Category'];?>"></td>
                  <td><input  class="w3-input w3-border w3-round-large"  type="text" name="t3[]" value="<?php echo $row_basic['Feed_Value'];?>"></td>
                  <td><input  class="w3-input w3-border w3-round-large"  type="text" name="t4[]" value="<?php echo $row_basic['Feed_Time'];?>"></td>
                  <td><input  class="w3-input w3-border w3-round-large"  type="text" name="t5[]" value="<?php echo $row_basic['Water'];?>"></td>
                </tr>
                <?php }?>
              </table>
		  </form>
