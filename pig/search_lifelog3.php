  ...
  <div class="w3-container w3-padding-32" style="padding-left:32px">
    ...
    <hr>
     <div class="w3-center" style="padding-bottom:32px">
      ...
      <button class="w3-btn w3-red"  onclick="javascript:location.href='search_lifelog3.php'">交配紀錄</button>
      <button class="w3-btn w3-black"  onclick="javascript:location.href='search_lifelog4.php'">生長資訊</button>
    ...
    <div class="w3-content" >
            ...
            <div class="mySlides  w3-animate-left" style="width:100%">
              <p style="padding-left:32px">可輸入時間進行篩選</p>
                <form action="search_lifelog3.php" method="post">
				母豬日期
              ...
              <div class="w3-container w3-sand w3-padding-32">
				...
				<form action="update_lifelog.php?id=4" method="post">
				<input class="w3-input w3-border w3-round-large w3-green" type="submit" value="修改"/>

                  <table class="w3-table" id="store4">
                    <tr>
                      <th  class="w3-blue w3-center">母豬日期</th>
                      <th  class="w3-blue w3-center"style="width:30%" >配種編號</th>
                      <th  class="w3-blue w3-center">公豬編號</th>
                      <th  class="w3-blue w3-center">精液冷凍天數</th>
                      <th  class="w3-blue w3-center">母豬發情等級</th>
                    </tr>
                    <?php
                    if($key==null && $key1==null){
                        $sql_basic = "SELECT * FROM `mating_record` limit 25";
                    }
                    if($key!=null)
                    {
                        $sql_basic = "SELECT * FROM `mating_record` where Mating_DateTime LIKE '".$key."%'";
                    }
                    if($key1!=null)
                    {
                        $sql_basic = "SELECT * FROM `mating_record` where Sow_ID='".$key1."'";
                    }
                    ...
                    while($row_basic = mysql_fetch_array($result_basic)){
                      ...
                      ?>
                      <tr>
                        <td><input class="w3-input w3-border w3-round-large" type="text" name="t1[]" value="<?php echo $row_basic['Mating_DateTime']; ?>" disabled></td>
					               <input type="hidden" name="t0[]" value="<?php echo $row_basic['ID']; ?>">
                        <td><input class="w3-input w3-border w3-round-large" type="text" name="t2[]" value="<?php echo $row_basic['Sow_ID'];?>"></td>
                        <td><input class="w3-input w3-border w3-round-large" type="text" name="t3[]" value="<?php echo $row_basic['Boar_ID'];?>"></td>
                        <td><input class="w3-input w3-border w3-round-large" type="text" name="t4[]" value="<?php echo $row_basic['Days_Of_Frozen_Semen'];?>"></td>
                        <td><input class="w3-input w3-border w3-round-large" type="text" name="t5[]" value="<?php echo $row_basic['Level_Of_Sow_Estrus_Reaction'];?>"></td>
                      </tr>
                      <?php }?>
                    </table>
					</form>
