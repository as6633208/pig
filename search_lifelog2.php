...
<div class="w3-main" style="margin-left:250px;">
  ...
  <div class="w3-container w3-padding-32" style="padding-left:32px">
    ...
    <hr>
      ...
      <button class="w3-btn  w3-red"  onclick="javascript:location.href='search_lifelog2.php'">疫苗施打</button>
    ...
    <div class="w3-content" >
          <div class="mySlides  w3-animate-left" style="width:100%">
              ...
              <form action="search_lifelog2.php" method="post">
			  施打疫苗日期
            ...
            <div class="w3-container w3-sand w3-padding-32">
			  ...
			  <form action="update_lifelog.php?id=3" method="post">
		      <input class="w3-input w3-border w3-round-large w3-green" type="submit" value="修改"/>
                <table class="w3-table" id="store3">
                  <tr>
                    <th  class="w3-blue w3-center">豬隻編號</th>
                    <th  class="w3-blue w3-center">疫苗編號</th>
                    <th  class="w3-blue w3-center">施打疫苗日期</th>
                  </tr>
                  <?php
              if($key==null && $key1==null){
                  $sql_basic = "SELECT * FROM `pig_vaccine_record`";
              }
              if($key!=null)
              {
                  $sql_basic = "SELECT * FROM `pig_vaccine_record` where Vaccine_Date LIKE '".$key."%'";
              }
              if($key1!=null)
              {
                  $sql_basic = "SELECT * FROM `pig_vaccine_record` where Pig_ID='".$key1."'";
                  ...
                  while($row_basic = mysql_fetch_array($result_basic)){
                    ...
                    <tr>
                      ...
                      <td><input class="w3-input w3-border w3-round-large" type="text" name="t2[]" value="<?php echo $row_basic['Vaccine_ID'];?>"></td>
                      <td><input class="w3-input w3-border w3-round-large" type="text" name="t3[]" value="<?php echo $row_basic['Vaccine_Date'];?>"></td>
                    </tr>
                    <?php }?>
                  </table>
                </div>
