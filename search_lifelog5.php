...
<div class="w3-main" style="margin-left:250px;">
  ...
  <div class="w3-container w3-padding-32" style="padding-left:32px">
    ...
    <div class="w3-center" style="padding-bottom:32px">
      ...
      <button class="w3-btn w3-red"  onclick="javascript:location.href='search_lifelog5.php'">其他紀錄</button>
    </div>
    <div class="w3-content" >
    
                <div class="mySlides  w3-animate-left" style="width:100%">
                  <p style="padding-left:32px">可輸入時間進行篩選</p>
                    <form action="search_lifelog5.php" method="post">
					紀錄時間
                  ...
                  <div class="w3-container w3-sand w3-padding-32">
					...
					<form action="update_lifelog.php?id=6" method="post">
		            <input class="w3-input w3-border w3-round-large w3-green" type="submit" value="修改"/>
                      <table class="w3-table" id="store6">
                        <tr>
                          <th  class="w3-blue w3-center">豬隻編號</th>
                          <th  class="w3-blue w3-center">紀錄時間</th>
                          <th  class="w3-blue w3-center">紀錄名稱</th
                          </tr>
                          <?php
                        if ($key == null && $key1 == null) {
                            $sql_basic = "SELECT * FROM `other_record`";
                        }
                                if ($key != null) {
                                    $sql_basic = "SELECT * FROM `other_record` where Datetime LIKE '" . $key . "%'";
                                }
                                if ($key1 != null) {
                                    $sql_basic = "SELECT * FROM `other_record` where Pig_ID='" . $key1 . "'";
                                }
                          ...
                          while($row_basic = mysql_fetch_array($result_basic)){
							...
							<input type="hidden" name="t0[]" value="<?php echo $row_basic['ID']; ?>">
                              ...
                              <td><input class="w3-input w3-border w3-round-large" type="text" name="t2[]" value="<?php echo $row_basic['Datetime'];?>"></td>
                              <td><input class="w3-input w3-border w3-round-large" type="text" name="t3[]" value="<?php echo $row_basic['Record_Name'];?>"></td>
                            </tr>
                            <?php }?>
                          </table>
						  </form>
